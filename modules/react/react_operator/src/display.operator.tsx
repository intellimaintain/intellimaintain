...
import { BaseMessage, Operator } from "@intellimaintain/domain";
...
export function isOperatorDetailsMessage ( message: BaseMessage ): message is OperatorDetailsMessage {
...
export const editOperatorDetails = <S extends any> ( operatorL: Lens<S, Operator> ) => ( state: LensState2<S, BaseMessage, SideEffect[], any> ): ReactElement => {
